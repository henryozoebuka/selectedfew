    ...
    return (
        <View style={{ flex: 1, backgroundColor: colors.backgroundColor }}>
            <ScrollView style={{ width: '90%', alignSelf: 'center', marginTop: SIZES.twenty }}>
                <Text style={{ fontWeight: 'bold', color: colors.textPrimary, marginBottom: SIZES.ten, fontSize: FONT.twenty }} >Edit Announcement</Text>
                <TextInput style={textInput} placeholder='Enter announcement title' placeholderTextColor={PLACEHOLDERCOLOR} value={data.title || ''} onChangeText={(value) => { handleChange(value, 'title') }} />
                <TextInput multiline={true} numberOfLines={50} style={[textInput, { textAlignVertical: 'top', minHeight: SIZES.twoHundred, marginTop: SIZES.twenty }]} placeholder='Type announcement here...' placeholderTextColor={PLACEHOLDERCOLOR} value={data.body || ''} onChangeText={(value) => { handleChange(value, 'body') }} />
